            ...
            <dl class='bitem'>
                ...
                <dd style='display:none' class='sitem' id=items3_1>
                    <ul class='sitemu' id=2>
                        <li><a href='email-seed.jsp' target='main'>发信息</a></li>
                        <li><a href='${pageContext.request.contextPath}/info/getEmailList' target='main'>发件箱</a></li>
                        <li><a href='${pageContext.request.contextPath}/info/getEmailList?flag=1' target='main'>收件箱</a></li>
                    </ul>
                </dd>
            </dl>
