    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
        ...
        <c:forEach items="${info.list}" var="tv">
            <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
                ...
                <td>
                    <fmt:formatDate value="${tv.starttime}" pattern="yyyy-MM-dd"/>
                </td>
                <td><fmt:formatDate value="${tv.endtime}" pattern="yyyy-MM-dd" /></td>
                <td>
                    <a href="${pageContext.request.contextPath}/daily/updateStatus?st=1&tid=${tv.id}">开始任务</a> |
                    <a href="${pageContext.request.contextPath}/daily/updateStatus?st=2&tid=${tv.id}">任务完成</a> | <a href="">查看详情</a></td>
            </tr>
        </c:forEach>
